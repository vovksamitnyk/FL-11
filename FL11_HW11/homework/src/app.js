...
function createNote() {
    if (counterNotes < allowedNumberOfNotes) {
        let getNewNote = document.getElementById('add_new_action');
        ...
        if (counterNotes >= allowedNumberOfNotes) {
            ...
            disableAdd();
            document.getElementById('add_new_action').disabled = 'disabled';
        }
    }
}

function f5 () {
    if (document.getElementById('add_new_action').value.length) {
        enableAdd();
    } else {
        disableAdd();
    }
...
function deleteNote () {
    ...
    if (counterNotes < allowedNumberOfNotes) {
        ...
        document.getElementById('add_new_action').disabled = '';
    }
}
